...
export declare function createPaginationSchema<T>(itemSchema: z.ZodType<T>): z.ZodIntersection<ZodObject<{
    items: z.ZodDefault<z.ZodArray<z.ZodType<T, z.ZodTypeDef, T>, "many">>;
