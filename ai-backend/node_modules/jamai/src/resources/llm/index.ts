...
import { ChatCompletionChunk, ChatCompletionChunkSchema, ChatRequest } from "@/resources/llm/chat";
...
export class LLM extends Base {
    public async modelInfo(params?: ModelInfoRequest): Promise<ModelInfoResponse> {
        ...
        const response = await this.httpClient.get(getURL, { params: params });
    ...
    public async generateChatCompletionsStream(params: ChatRequest) {
        ...
        const stream = new ReadableStream<ChatCompletionChunk>({
            async start(controller: ReadableStreamDefaultController<ChatCompletionChunk>) {
